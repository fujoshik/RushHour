...
namespace RushHour.Data.Migrations
{
    ...
    [Migration("20230601115250_AddSaltToPassword")]
    partial class AddSaltToPassword
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RushHour.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("44ae9f66-8fcf-4fbc-9bcd-d0216be48b29"),
                            Email = "admin",
                            FullName = "John Doe",
                            Password = "9CEBB39C72E2E5BF0FCE6197CA8581AE8399FAAA705D666D248190E8D9B385418EA080D649586D20F95BBAE405773A3F7C1915C548C4DD6E8657DE26298D8EB1",
                            Role = 0,
                            Salt = "7syZXC7fGEG5J10cSZAaoCNqPItdQHHL3sQCMBidv70K8DjZoLRzcot1IZNrZYnXGPWwFjKs85oISlOpAO5Zdg=="
                        });
                });
