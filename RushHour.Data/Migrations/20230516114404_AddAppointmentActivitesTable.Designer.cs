...
namespace RushHour.Data.Migrations
{
    ...
    [Migration("20230516114404_AddAppointmentActivitesTable")]
    partial class AddAppointmentActivitesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RushHour.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3703acad-2e09-4904-a650-84eb84f0c20a"),
                            Email = "admin",
                            FullName = "John Doe",
                            Password = "$2a$11$Ukiosf4.LqeCQRthTf.DNeeFzvSN9GPpPX2fK.Z1jvRmngISymVkK",
                            Role = 0
                        });
                });
