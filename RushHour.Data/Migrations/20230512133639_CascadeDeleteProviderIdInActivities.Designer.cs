...
namespace RushHour.Data.Migrations
{
    ...
    [Migration("20230512133639_CascadeDeleteProviderIdInActivities")]
    partial class CascadeDeleteProviderIdInActivities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RushHour.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("574206a4-278d-4f7e-a86f-2bbef1833b46"),
                            Email = "admin",
                            FullName = "John Doe",
                            Password = "$2a$11$Zns87TTZcMXH20nOA86dZub1VUISky.TBi/LVBNsKHkLXqU1rLYEi",
                            Role = 0
                        });
                });
