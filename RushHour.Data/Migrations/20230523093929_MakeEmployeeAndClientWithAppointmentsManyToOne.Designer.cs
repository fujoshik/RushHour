...
namespace RushHour.Data.Migrations
{
    ...
    [Migration("20230523093929_MakeEmployeeAndClientWithAppointmentsManyToOne")]
    partial class MakeEmployeeAndClientWithAppointmentsManyToOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RushHour.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6b58f771-0e35-4b8b-b51d-2d007abb2689"),
                            Email = "admin",
                            FullName = "John Doe",
                            Password = "$2a$11$Pw/6VlUqHwW1K8c70fzQIuZpnz5Mno7Nz2E0KhXQtqg9yE8ywdXay",
                            Role = 0
                        });
                });
